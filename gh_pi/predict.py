''' 
     this is the main object recognition program that runs on the Raspberry Pi 
'''
...
if __name__ == "__main__":
    ...
    # change this number if you want more photos per test 
    numofphotos = 10
    ...
    #  need to set up your own MySQL database 
    DBServer = 'raiobjects.chbvjvx33tzy.us-west-1.rds.amazonaws.com'
    DBUser = 'rai'
    DBPass = 'R$94A7b!L'
    DBName = 'recycleai'
    ...
    for i in range(1, numofphotos):
        ...
        if similarity_to_previous < 95:
            ...
            # if the object is too similar to last photo
            if (int(thescore) > 98):
